  ...
  const uiGenerator = (function () {
    ...
    return {
      ...
      getHtml: function ({pageSource, swagger}) {
        ...
        const snippetPath = path.resolve(__dirname, '../../../layout/swagger-ui/snippet.ejs');
        const libsPath = path.resolve(__dirname, '../../../layout/swagger-ui/libs.ejs');

        return hexo.render.render({path: snippetPath}, { id: instance, swagger: swagger, url_for: url_for })
          .then((snippet) => {
